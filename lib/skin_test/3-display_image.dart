    ...
    setState(() {
      ...
      if (last_dance != 'test') {
        ...
        if ((final_result != 'Squamous Cell Carcinoma' &&
          ...
          if (affected_area_shape != null &&
              affected_area_shape == 'Raised or Bumby') {
            benign_Keratosis += abo_heiba_num;
            vascular_Lesion += abo_heiba_num;
            melanoma += abo_heiba_num;
            melanocytic_Nevus += abo_heiba_num;
          ...
          if (affected_area_shape != null &&
              affected_area_shape == 'Skin loss or Sunken') {
            benign_Keratosis += abo_heiba_num;
            vascular_Lesion += abo_heiba_num;
            melanoma += 0;
            melanocytic_Nevus += abo_heiba_num;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: PreferredSize(
          preferredSize: Size.fromHeight(60.0), // Set custom height
          child: AppBar(
            backgroundColor:
            ...
            leading: IconButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Load_image()),
                );
              },
            ),
            title: Text(
